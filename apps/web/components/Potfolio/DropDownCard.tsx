...
export default function ExitDropdownCard() {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 w-full max-w-md mx-auto shadow-md border border-gray-200">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-4 space-y-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => setExitPrice((prev) => Math.max(1, prev - 1))}
              className="border rounded-lg px-3 py-1"
            >
              <Minus size={16} />
            </button>
            <div className="px-3 py-1 border rounded-lg text-base font-semibold">₹{exitPrice.toFixed(1)}</div>
            <button
              onClick={() => setExitPrice((prev) => prev + 1)}
              className="border rounded-lg px-3 py-1"
            >
              <Plus size={16} />
            </button>
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="px-4 py-1 border rounded-lg text-base font-semibold">{quantity}</div>
            <button
        ...
        <div className="text-right text-sm font-semibold">
          Exit value <span className="ml-2">₹{exitValue.toFixed(1)}</span>
        </div>
      </div>
      ...
      {/* Exit Button */}
      <button className="mt-4 w-full bg-black text-white py-2 rounded-xl font-semibold hover:opacity-90 transition">
        Exit
      </button>
    </div>
  );
