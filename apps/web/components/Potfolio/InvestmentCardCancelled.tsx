...
import { CancelledOrder, ExitOrder, MatchOrder } from './types';

export default function InvestmentCardCancelled({cancelledOrder}:{cancelledOrder: CancelledOrder[]}) {
    ...
    cancelledOrder.map((i, key) => (
      ...
      <div className="flex justify-between items-center">
        <div className="flex items-center gap-6">
          ...
          <div className="text-center">
            <p className="font-semibold">₹{i.buyPrice.toFixed(1)}</p>
